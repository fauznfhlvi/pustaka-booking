...
<head>
    ...
    <link rel="stylesheet" href="<?= base_url('assets/'); ?>vendor/bootstrap.css"> <!-- Perubahan -->
            ...
            <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                <div class="navbar-nav">
                    ...
                    <?php if (!empty($this->session->userdata('email'))) { ?>
                        ...
                        <a class="nav-item nav-link" href="<?= base_url('member/logout'); ?>"><i class="fas fa-fw fa-sign-out-alt"></i> Log out</a> <!-- Perubahan -->
                    <?php } else { ?>
                        <a class="nav-item nav-link" data-toggle="modal" data-target="#daftarModal" href="#"><i class="fas fa-fw fa-user-plus"></i> Daftar</a> <!-- Perubahan -->
                        <a class="nav-item nav-link" data-toggle="modal" data-target="#loginModal" href="#"><i class="fas fa-fw fa-sign-in-alt"></i> Log in</a> <!-- Perubahan -->
                    <?php } ?>
